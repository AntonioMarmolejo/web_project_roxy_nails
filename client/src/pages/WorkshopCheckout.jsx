...
export default function WorkshopCheckout() {
    ...
    if (loading) {
        return <p className="checkout-empty" style={{ padding: '6rem 0' }}>Cargando...</p>
    }
    ...
    if (!workshop) {
        return (
            <div className="checkout-empty">
                ...
                <h2 className="checkout-empty-title">Taller no disponible</h2>
                <p className="checkout-empty-sub">Puede que ya no exista o se haya dado de baja.</p>
            ...
            <div className="checkout-success">
                ...
                <div className="checkout-success-box">
                    <div className="checkout-success-details">
                        ...
                        <span>
                            ...
                            <span className="checkout-success-total">${success.price.toFixed(2)}</span>
                        </span>
                ...
                {user && (
                    <div style={{ marginTop: '1rem' }}>
                        <button onClick={() => navigate('/mis-talleres')} className="checkout-success-link-btn">
                            Ver mis talleres
                        </button>
                    </div>
                )}
    ...
    return (
        <>
            ...
            <div className="rn-checkout-grid checkout-grid">
                {full ? (
                    <div className="checkout-form" style={{ textAlign: 'center', color: '#9E7080' }}>
                    ...
                    <form onSubmit={handleSubmit} className="checkout-form">
                        ...
                        <div className="checkout-fields">
                            ...
                            <div>
                                <label className="checkout-label">Notas</label>
                                <textarea
                ...
                <div className="rn-order-summary checkout-summary">
                    ...
                    <div className="checkout-summary-total-row">
                        <span className="checkout-summary-total-label">Precio</span>
                        <span className="checkout-summary-total-value">${workshop.price.toFixed(2)}</span>
                    </div>
                </div>
            </div>
        </>
